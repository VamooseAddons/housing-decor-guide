...
local function BuildActionMeta()
    ...
    return {
        ...
        [A.ACQ_SET_ITEMS_VIEW_MODE]      = { persists = true,  combatUnsafe = false,
        ...
        [A.RECIPES_TOGGLE_PROFESSION]    = { persists = true,  combatUnsafe = false,
            invalidates = { "account.ui.recipes.professionFilterByChar" } },
        [A.RECIPES_TOGGLE_EXPANSION]     = { persists = true,  combatUnsafe = false,
        ...
        [A.SHOPPING_ITEM_SET_QTY] = { persists = true, combatUnsafe = false,
            invalidates = { "account.vendorShoppingLists" } },
        [A.SHOPPING_ITEM_ADJUST_QTY] = { persists = true, combatUnsafe = false,
            invalidates = { "account.vendorShoppingLists" } },
        ...
        [A.PROJECTS_FOCUS_HOUSE]         = { persists = true, combatUnsafe = false,
            invalidates = "*" },
        [A.PROJECTS_PICKER_SET_SOURCE]   = T({ "session.ui.projects.pickerSource" }),
        [A.PROJECTS_FURN_TOGGLE_COLLAPSE] = T({ "session.ui.projects.furnCollapsed" }),
        ...
        -- the change tick; session.furnIndex is the maintained reverse index.
        [A.FURN_SET_CREATE]      = { persists = true, combatUnsafe = false,
            invalidates = { "account.furnishingSets", "session.furn" } },
        [A.FURN_SET_RENAME]      = { persists = true, combatUnsafe = false,
            invalidates = { "account.furnishingSets" } },
        [A.FURN_SET_DELETE]      = { persists = true, combatUnsafe = false,
            invalidates = { "account.furnishingSets", "account.rooms", "session.furnIndex", "session.furn" } },
        [A.FURN_SET_ITEM_ADD]    = { persists = true, combatUnsafe = false,
            invalidates = { "account.furnishingSets" } },
        [A.FURN_SET_ITEM_REMOVE] = { persists = true, combatUnsafe = false,
            invalidates = { "account.furnishingSets" } },
        [A.FURN_SET_PROMOTE]     = { persists = true, combatUnsafe = false,
            invalidates = { "account.furnishingSets", "session.furn" } },
        [A.FURN_ROOM_CREATE]     = { persists = true, combatUnsafe = false,
            invalidates = { "account.rooms", "account.projects.layouts", "session.furn", "session.furnIndex" } },
        [A.FURN_ROOM_RENAME]     = { persists = true, combatUnsafe = false,
            invalidates = { "account.rooms" } },
        [A.FURN_ROOM_DELETE]     = { persists = true, combatUnsafe = false,
            invalidates = { "account.rooms", "account.furnishingSets", "account.projects.layouts", "session.furn", "session.furnIndex" } },
        [A.FURN_ROOM_EQUIP]      = { persists = true, combatUnsafe = false,
            invalidates = { "account.rooms", "session.furn", "session.furnIndex" } },
        [A.FURN_ROOM_UNEQUIP]    = { persists = true, combatUnsafe = false,
            invalidates = { "account.rooms", "session.furn", "session.furnIndex" } },
        [A.FURN_ROOM_DUPLICATE]  = { persists = true, combatUnsafe = false,
            invalidates = { "account.rooms", "account.furnishingSets", "account.projects.layouts", "session.furn", "session.furnIndex" } },
        [A.LAYOUT_PLACE]         = { persists = true, combatUnsafe = false,
            invalidates = { "account.projects.layouts", "session.furn", "session.furnIndex" } },
        [A.LAYOUT_MOVE]          = { persists = true, combatUnsafe = false,
            invalidates = { "account.projects.layouts" } },
        [A.LAYOUT_REMOVE_PLACEMENT] = { persists = true, combatUnsafe = false,
            invalidates = { "account.projects.layouts", "session.furn", "session.furnIndex" } },
        [A.LAYOUT_ASSIGN]        = { persists = true, combatUnsafe = false,
            invalidates = { "account.projects.layouts", "account.rooms", "session.furn", "session.furnIndex" } },
        [A.LAYOUT_UNASSIGN]      = { persists = true, combatUnsafe = false,
            invalidates = { "account.projects.layouts", "session.furn", "session.furnIndex" } },
        [A.LAYOUT_SWAP_ROOM]     = { persists = true, combatUnsafe = false,
            invalidates = { "account.projects.layouts", "account.rooms", "session.furn", "session.furnIndex" } },
    }
end
